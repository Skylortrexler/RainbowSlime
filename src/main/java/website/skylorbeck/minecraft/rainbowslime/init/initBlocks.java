...
public class initBlocks {
    ...
    public static void register() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_light_blue_block"), SLIME_LIGHT_BLUE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_yellow_block"), SLIME_YELLOW_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_lime_block"), SLIME_LIME_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_pink_block"), SLIME_PINK_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_gray_block"), SLIME_GRAY_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_light_gray_block"), SLIME_LIGHT_GRAY_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_cyan_block"), SLIME_CYAN_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_purple_block"), SLIME_PURPLE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_blue_block"), SLIME_BLUE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_brown_block"), SLIME_BROWN_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_green_block"), SLIME_GREEN_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_red_block"), SLIME_RED_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RainbowSlime.MOD_ID, "slime_black_block"), SLIME_BLACK_BLOCK);
    }
}
