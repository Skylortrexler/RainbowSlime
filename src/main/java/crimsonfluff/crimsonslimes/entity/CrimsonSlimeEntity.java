...
public class CrimsonSlimeEntity extends SlimeEntity {
    public static final TrackedData<Integer> iCOLOUR = DataTracker.registerData(CrimsonSlimeEntity.class, TrackedDataHandlerRegistry.INTEGER);
//    public Identifier texture = null;

    public CrimsonSlimeEntity(EntityType<? extends SlimeEntity> entityIn, World levelIn) {
    ...
    public void remove(RemovalReason reason) {
        ...
        if (!this.world.isClient && i > 1 && this.isDead()) {
            ...
            for(int l = 0; l < k; ++l) {
                ...
                CrimsonSlimeEntity slimeEntity = (CrimsonSlimeEntity)this.getType().create(this.world);
                if (slimeEntity != null) {
