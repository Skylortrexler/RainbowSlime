package crimsonfluff.crimsonslimes.client;

import crimsonfluff.crimsonslimes.entity.CrimsonSlimeRenderer;
...
public class initClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        EntityRendererRegistry.register(initEntities.SLIME, CrimsonSlimeRenderer::new);
